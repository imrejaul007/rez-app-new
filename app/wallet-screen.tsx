...
const WalletScreen: React.FC<WalletScreenProps> = ({ onNavigateBack, onCoinPress }) => {
  ...
  const segmentShortcut = useMemo(() => {
    ...
    return {
      ...
      onPress: () => router.push(entry.route as unknown),
      badge: 'VERIFIED',
    };
  }, [segment, router]);
        ...
        {isNotOnboarded ? (
          <View style={styles.errorContainer}>
            ...
            <Pressable
              ...
              onPress={() => router.push('/onboarding/profile' as unknown)}
          ...
          {(segment === 'verified_student' || statedIdentity === 'student') && (
            ...
            >
              ...
              >
                ...
                {/* Micro Pack CTA */}
                <Pressable
                  onPress={() => router.push('/value-packs?persona=student' as unknown)}
                  style={{
          ...
          {(segment === 'verified_employee' || statedIdentity === 'corporate') && (
            ...
            >
              ...
              >
                ...
                {/* Value Pack CTA */}
                <Pressable
                  onPress={() => router.push('/value-packs?persona=corporate' as unknown)}
                  style={{
                    backgroundColor: colors.lightMustard,
                    borderRadius: 12,
                    paddingVertical: 11,
