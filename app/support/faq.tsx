...
function FAQPage() {
  ...
  const getCategoryColor = (category: string) => {
    const categoryColors: { [key: string]: string } = {
      ...
      delivery: (colors as unknown as Record<string, string>).brand?.pink || Colors.error,
      ...
      <View style={styles.categoryFilterWrapper}>
        ...
        >
          {allCategories.map((category) => (
            ...
            >
              <Ionicons
                name={getCategoryIcon(category.key) as unknown as keyof typeof Ionicons.glyphMap}
                size={16}
        ...
        <Pressable style={styles.faqHeader} onPress={() => toggleFAQ(faq._id)}>
          <View style={styles.questionContainer}>
            <View style={[styles.categoryIndicator, { backgroundColor: `${categoryColor}20` }]}>
              <Ionicons
                name={getCategoryIcon(faq.category) as unknown as keyof typeof Ionicons.glyphMap}
                size={14}
                color={categoryColor}
              />
            </View>
