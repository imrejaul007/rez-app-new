  ...
  if (status === 'failed') {
    return (
      <ThemedView style={styles.container}>
        ...
        <LinearGradient colors={[Colors.error, Colors.errorScale[700]] as unknown as string[]} style={styles.header}>
      ...
      >
        ...
        <View style={styles.detailsCard}>
          <View style={styles.tierBadge}>
            <LinearGradient colors={tierGradient as unknown as string[]} style={styles.tierBadgeGradient}>
