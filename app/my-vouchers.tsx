...
const MyVouchersPage = () => {
  ...
  const handleBackPress = useCallback(() => {
    goBack('/account' as unknown as string);
  }, [goBack]);
    ...
    async (voucher: UserVoucher) => {
      ...
      if (!cartState.items || cartState.items.length === 0) {
        platformAlertConfirm(
          ...
          () => router.push('/(tabs)' as unknown as string),
          'Browse Products',
        );
        return;
      }
      ...
      try {
        ...
        if (!validationResult.success || !validationResult.data?.valid) {
          ...
          const errorMessage =
            ...
            (validationResult.data as unknown as Record<string, unknown>)?.message ||
        ...
        platformAlertConfirm(
          ...
          () =>
            router.push({
              pathname: '/cart' as unknown as string,
