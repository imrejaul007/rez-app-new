    ...
    <View style={txStyles.item}>
      <View style={txStyles.left}>
        <View style={[txStyles.iconWrap, { backgroundColor: txCfg.color + '20' }]}>
          <Ionicons name={txCfg.icon as any as keyof typeof Ionicons.glyphMap} size={18} color={txCfg.color} />
        </View>
      ...
      <View style={txStyles.right}>
        ...
        <View style={[txStyles.coinBadge, { backgroundColor: coinCfg.color + '15' }]}>
          <Ionicons name={coinCfg.icon as any as keyof typeof Ionicons.glyphMap} size={10} color={coinCfg.color} />
        </View>
      </View>
    </View>
  );
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.filterScroll}>
            {(Object.entries(COIN_TYPE_CONFIG) as [KarmaCoinFilter, (typeof COIN_TYPE_CONFIG)['all']][]).map(
              ([key, cfg]) => (
                ...
                >
                  <Ionicons
                    name={cfg.icon as any as keyof typeof Ionicons.glyphMap}
                    size={14}
