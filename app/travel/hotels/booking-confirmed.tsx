    ...
    <View style={[styles.root, { paddingTop: insets.top }]}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        ...
        <Animated.View style={[styles.cards, contentStyle]}>
          ...
          {/* Actions */}
          <Pressable style={styles.primaryBtn} onPress={() => router.replace('/my-bookings' as any as string)}>
          ...
          <Pressable style={styles.secondaryBtn} onPress={() => router.replace('/travel/hotels' as any as string)}>
