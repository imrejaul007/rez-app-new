    ...
    <View style={[styles.root, { paddingTop: insets.top }]}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        ...
        <Animated.View style={[styles.cards, contentStyle]}>
          ...
          {/* Actions */}
          <Pressable style={styles.primaryBtn} onPress={() => router.replace('/travel/hotels/BookingsPage' as any)}>
          ...
          <Pressable style={styles.secondaryBtn} onPress={() => router.replace('/travel/hotels' as any)}>
