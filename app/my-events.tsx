  ...
  const renderEmptyState = () => {
    ...
    return (
      <View style={styles.emptyState}>
        ...
        <Pressable style={styles.exploreButton} onPress={() => router.push('/events' as any as string)}>
    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.headerTop}>
          ...
          <Pressable onPress={() => router.push('/events' as any as string)} style={styles.backButton}>
