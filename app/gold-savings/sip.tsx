    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.emptyContainer}>
        <View style={styles.iconContainer}>
          <Ionicons name="repeat-outline" size={56} color="#CBD5E1" />
        </View>
        <ThemedText style={styles.emptyTitle}>Coming Soon</ThemedText>
        <ThemedText style={styles.emptySubtitle}>
          Set up a Systematic Investment Plan (SIP) to automatically buy gold at regular intervals. This feature will be available soon.
        </ThemedText>
      </View>
    </SafeAreaView>
  );
