...
function CoinsScreen() {
  ...
  const coinBalance = 1425;
  const expiringCoins = 150;

  const filteredTransactions = activeTab === 'all'
    ? DUMMY_TRANSACTIONS
    : DUMMY_TRANSACTIONS.filter(t => t.type === activeTab);
...
const styles = StyleSheet.create({
  ...
  expiringCard: { backgroundColor: '#fffbeb', borderRadius: 12, padding: 16, flexDirection: 'row', alignItems: 'center', gap: 12, borderWidth: 1, borderColor: '#fcd34d' },
  expiringInfo: { flex: 1 },
  ...
  wayCard: { flex: 1, minWidth: '45%', alignItems: 'center', gap: 8, backgroundColor: '#fff', borderRadius: 12, padding: 16, borderWidth: 1, borderColor: '#e5e7eb' },
  ...
  transactionItem: { backgroundColor: '#fff', borderRadius: 12, padding: 12, flexDirection: 'row', alignItems: 'center', gap: 12, borderWidth: 1, borderColor: '#e5e7eb' },
  ...
  learnBtn: { backgroundColor: '#f3f4f6', borderRadius: 12, padding: 16, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, marginTop: 8, marginBottom: 20 },
