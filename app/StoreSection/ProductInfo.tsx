  ...
  const onStoreVisitPress = () => {
    ...
    if (dynamicData?.store || dynamicData?.merchant) {
      const storeData = {
        ...
        description: (dynamicData.store as unknown as Record<string, unknown>)?.description || '',
        logo: dynamicData.store?.logo || '',
        banner: (dynamicData.store as unknown as Record<string, unknown>)?.banner || '',
        ...
        minimumOrder: (dynamicData.store?.operationalInfo as unknown as Record<string, unknown>)?.minimumOrder || 0,
      };
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 5 }}>
        ...
        {productPrice > 0 &&
          (() => {
            ...
            const originalPrice =
              (dynamicData?.price as unknown as Record<string, unknown>)?.original ||
