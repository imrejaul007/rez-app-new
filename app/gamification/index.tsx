      ...
      >
        ...
        {activeTab === 'achievements' && (
          <View style={styles.content}>
            ...
            <Pressable style={styles.viewAllButton} onPress={() => router.push('/badges' as unknown)}>
        ...
        {activeTab === 'leaderboards' && (
          <View style={styles.content}>
            <Pressable
              ...
              onPress={() => router.push('/playandearn/leaderboard' as unknown)}
            >
        ...
        <View style={styles.quickAccess}>
          ...
          <View style={styles.gameRow}>
            <Pressable style={styles.gameCard} onPress={() => router.push('/games/spin-wheel' as unknown)}>
              <LinearGradient
            ...
            <Pressable style={styles.gameCard} onPress={() => router.push('/scratch-card' as unknown)}>
              <LinearGradient
            ...
            <Pressable style={styles.gameCard} onPress={() => router.push('/games/quiz' as unknown)}>
              <LinearGradient
