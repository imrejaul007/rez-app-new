        ...
        >
          <View style={styles.scoreContent}>
            ...
            <View style={styles.tierBadge}>
              <Ionicons name={tierInfo.icon as unknown as keyof typeof Ionicons.glyphMap} size={32} color="#fff" />
            </View>
          </View>
          ...
          {(() => {
            ...
            return (
              <View style={styles.nextTierCard}>
                <Ionicons
                  name={nextTierInfo.icon as unknown as keyof typeof Ionicons.glyphMap}
                  size={24}
