    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.ctaSection}>
          ...
          <Pressable style={styles.ctaCard} onPress={() => router.push('/mall' as unknown)}>
          ...
          <Pressable style={styles.ctaCard} onPress={() => router.push('/referral' as unknown)}>
          ...
          <Pressable style={styles.ctaCard} onPress={() => router.push('/games' as unknown)}>
