  ...
  const handleSubmit = useCallback(async () => {
    ...
    if (isAddingEvidence) {
      ...
      try {
        ...
        if (response.success) {
          ...
          platformAlert('Error', (response as unknown as Record<string, unknown>).message || 'Failed to add evidence');
        }
      } catch (err: any) {
    ...
    try {
      ...
      if (response.success) {
        ...
        platformAlert('Error', (response as unknown as Record<string, unknown>).message || 'Failed to submit dispute');
      }
    } catch (err: any) {
