          ...
          >
            ...
            <View style={styles.quickActions}>
              <Pressable
                ...
                onPress={() => router.push('/prive/redeem' as unknown)}
              ...
              <Pressable
                ...
                onPress={() => router.push('/prive/earnings' as unknown)}
              >
                <View style={styles.actionIcon}>
                  <Text style={styles.actionEmoji}>📈</Text>
                </View>
              ...
              <Pressable
                style={[styles.actionButton, styles.actionButtonGold]}
                onPress={() => router.push('/prive/vouchers' as unknown)}
              >
                <View style={styles.actionIcon}>
              ...
              <Pressable
                style={[styles.actionButton, styles.actionButtonGold]}
                onPress={() => router.push('/prive/smart-spend' as unknown)}
              >
                <View style={styles.actionIcon}>
                  <Text style={styles.actionEmoji}>💎</Text>
                </View>
