  ...
  const renderProductCard = useCallback(
    ({ item: product }: { item: FashionProduct }) => (
      <Pressable
        ...
        onPress={() => router.push(`/product-page?cardId=${product._id}&cardType=product` as unknown)}
      >
      ...
      <View style={styles.container}>
        ...
        >
          <View style={styles.headerTop}>
            ...
            <Pressable onPress={() => router.push('/cart' as unknown)} style={styles.cartButton}>
                ...
                <View style={styles.categoriesGrid}>
                  {subcategories.map((cat) => (
                    <Pressable
                      ...
                      onPress={() => router.push(`/categories/${cat.slug}` as unknown)}
                    >
                ...
                <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                  {trendingProducts.map((tp) => (
                    <Pressable
                      ...
                      onPress={() => router.push(`/product-page?cardId=${tp._id}&cardType=product` as unknown)}
                    >
                      <CachedImage
                        source={tp.image}
            ...
            {stores.length > 0 && (
              <View style={styles.section}>
                <View style={styles.sectionHeader}>
                  ...
                  <Pressable onPress={() => router.push(`/explore/stores?category=${FASHION_SLUG}` as unknown)}>
                    <Text style={styles.viewAllText}>View All</Text>
                  </Pressable>
                </View>
                <ScrollView horizontal showsHorizontalScrollIndicator={false}>
