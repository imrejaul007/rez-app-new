        ...
        <Pressable style={styles.planListCard} onPress={() => handlePlanPress(item)}>
          ...
          {item.claimSettlementRatio > 0 && (
            <View style={styles.claimRatioRow}>
              <Ionicons
                name={'checkmark-shield' as unknown as keyof typeof Ionicons.glyphMap}
                size={14}
        ...
        <View style={styles.whyGrid}>
          {[
            ...
            <View key={index} style={styles.whyCard}>
              <Ionicons name={item.icon as unknown as keyof typeof Ionicons.glyphMap} size={28} color={Colors.gold} />
