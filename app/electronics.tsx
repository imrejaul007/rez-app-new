...
const ElectronicsPage: React.FC = () => {
  ...
  const renderSubcategoryItem = useCallback(
    ({ item }: { item: Subcategory }) => (
      <Pressable style={styles.categoryCard} onPress={() => router.push(`/category/${item.slug}` as any as string)}>
  ...
  const renderStoreItem = useCallback(
    ({ item }: { item: Store }) => (
      <Pressable style={styles.brandCard} onPress={() => router.push(`/store/${item._id}` as any as string)}>
        {item.logo ? (
    ...
    ({ item }: { item: Product }) => {
      ...
      return (
        <Pressable
          ...
          onPress={() => router.push(`/product-page?cardId=${item._id}&cardType=product` as any as string)}
        >
          {imageUri ? (
      ...
      <>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <Pressable onPress={() => router.push(`/stores?category=${CATEGORY_SLUG}` as any as string)}>
        ...
        <View style={[styles.section, { paddingBottom: 0 }]}>
          <View style={styles.sectionHeader}>
            ...
            <Pressable onPress={() => router.push(`/products?category=${CATEGORY_SLUG}` as any as string)}>
              <Text style={styles.viewAllText}>View All</Text>
            </Pressable>
          </View>
        </View>
        ...
        <View style={styles.promoBanner}>
          ...
          >
            ...
            <Pressable
              ...
              onPress={() => router.push(`/products?category=${CATEGORY_SLUG}&sortBy=price_low` as any as string)}
            >
    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.headerTop}>
          ...
          <Pressable style={styles.cartButton} onPress={() => router.push('/cart' as any as string)}>
      ...
      <View style={styles.filtersContainer}>
        <FlashList
          data={FILTER_OPTIONS as any as FilterType[]}
          horizontal
          showsHorizontalScrollIndicator={false}
