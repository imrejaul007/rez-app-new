 ...
 * - pricing.mrp: original/Maximum Retail Price
 *
...
export interface UnifiedProduct {
  ...
  // PRICING - CANONICAL FORMAT: pricing.selling + pricing.mrp
...
/**
 * CANONICAL PRICING FORMAT (derived from backend's pricing.selling/mrp)
 *
...
export interface ProductPrice {
  ...
  original?: number; // Alias for mrp (for backward compatibility)
