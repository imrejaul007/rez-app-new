...
export const referralTierApi = {
  ...
  async getTier(): Promise<{
    ...
    try {
      const response = await apiClient.get<any>('/referral/tier');
  ...
  async getRewards(): Promise<{
    ...
    try {
      const response = await apiClient.get<any>('/referral/rewards');
  ...
  async claimReward(referralId: string, rewardIndex: number): Promise<any> {
    try {
      const response = await apiClient.post<any>('/referral/claim-reward', {
        referralId,
        rewardIndex
      });
      return extractData(response);
  ...
  async getLeaderboard(limit: number = 100): Promise<{
    ...
    try {
      const response = await apiClient.get<any>('/referral/leaderboard', { limit });
  ...
  async generateQR(): Promise<{
    ...
    try {
      const response = await apiClient.post<any>('/referral/generate-qr');
      return extractData(response);
    } catch (error) {
      throw error;
    }
  ...
  async getMilestones(): Promise<{
    ...
    try {
      const response = await apiClient.get<any>('/referral/milestones');
      return extractData(response);
    } catch (error) {
      throw error;
    }
  ...
  async checkUpgrade(): Promise<{
    ...
    try {
      const response = await apiClient.get<any>('/referral/check-upgrade');
      return extractData(response);
    } catch (error) {
      throw error;
    }
  ...
  async validateCode(code: string): Promise<{
    ...
    try {
      const response = await apiClient.post<any>('/referral/validate-code', { code });
      return extractData(response);
    } catch (error) {
      throw error;
    }
  ...
  async applyCode(code: string, metadata?: any): Promise<{
    ...
    try {
      const response = await apiClient.post<any>('/referral/apply-code', {
        code,
        metadata
      });
      return extractData(response);
  ...
  async getAnalytics(startDate?: Date, endDate?: Date): Promise<any> {
    try {
      const response = await apiClient.get<any>('/referral/analytics', {
