...
export const realVideosApi = {
  ...
  async getVideos(params?: {
    ...
    return apiClient.get<any>(`/videos?${queryParams.toString()}`).then(response => response as ApiResponse<{ videos: Video[]; pagination: any }>);
  },
  ...
  async getTrendingVideos(params?: {
    ...
    return apiClient.get<any>(`/videos/trending?${queryParams.toString()}`).then(response => response as ApiResponse<Video[]>);
  },
  ...
  async getVideosByCategory(
    ...
    return apiClient.get<any>(`/videos/category/${category}?${queryParams.toString()}`).then(response => response as ApiResponse<{ videos: Video[]; pagination: any }>);
  },
  ...
  async getVideosByCreator(
    ...
    return apiClient.get<any>(`/videos/creator/${creatorId}?${queryParams.toString()}`).then(response => response as ApiResponse<{ videos: Video[]; pagination: any }>);
  },
  ...
  async getVideoById(videoId: string): Promise<any> {
    const response = await apiClient.get<any>(`/videos/${videoId}`);
  ...
  async toggleVideoLike(videoId: string): Promise<ApiResponse<{ liked: boolean; likeCount: number; isLiked?: boolean; totalLikes?: number }>> {
    const response = await apiClient.post<any>(`/videos/${videoId}/like`);
  ...
  async toggleBookmark(videoId: string): Promise<ApiResponse<{ videoId: string; isBookmarked: boolean; totalBookmarks: number }>> {
    const response = await apiClient.post<any>(`/videos/${videoId}/bookmark`);
  ...
  async trackView(videoId: string): Promise<ApiResponse<{ videoId: string; views: number }>> {
    const response = await apiClient.post<any>(`/videos/${videoId}/view`);
  ...
  async addVideoComment(videoId: string, comment: string): Promise<ApiResponse<any>> {
    return apiClient.post<any>(`/videos/${videoId}/comments`, { comment }).then(response => response as ApiResponse<any>);
  },
  ...
  async getVideoComments(
    ...
    return apiClient.get<any>(`/videos/${videoId}/comments?${queryParams.toString()}`).then(response => response as ApiResponse<{ comments: any[]; pagination: any }>);
  },
  ...
  async searchVideos(params: {
    ...
    return apiClient.get<any>(`/videos/search?${queryParams.toString()}`).then(response => response as ApiResponse<{ videos: Video[]; pagination: any }>);
  },
  ...
  async reportVideo(
    ...
    return apiClient.post<any>(`/videos/${videoId}/report`, { reason, details }).then(response => response as ApiResponse<{ videoId: string; reportCount: number; isReported: boolean }>);
  },
};
