...
export const fallbackEvents: EventItem[] = [
  {
    ...
    image: 'https://placehold.co/400x200?text=Weekend+Shopping+Festival',
  ...
  },
  {
    ...
    image: 'https://placehold.co/400x200?text=Virtual+Product+Launch',
  ...
  },
  {
    ...
    image: 'https://placehold.co/400x200?text=Fashion+Show+And+Sale',
...
export const fallbackRecommendations: RecommendationItem[] = [
  {
    ...
    brand: 'AudioTech',
    image: 'https://placehold.co/400x300?text=Premium+Wireless+Headphones',
  ...
  },
  {
    ...
    brand: 'FitPro',
    image: 'https://placehold.co/400x300?text=Smart+Fitness+Watch',
  ...
  },
  {
    ...
    brand: 'EcoWear',
    image: 'https://placehold.co/400x300?text=Organic+Cotton+T-Shirt',
  ...
  },
  {
    ...
    brand: 'HydroLife',
    image: 'https://placehold.co/400x300?text=Stainless+Steel+Water+Bottle',
...
export const fallbackTrendingStores: StoreItem[] = [
  {
    ...
    image: 'https://placehold.co/400x200?text=TechHub+Electronics',
  ...
  },
  {
    ...
    image: 'https://placehold.co/400x200?text=Fresh+Mart+Groceries',
  ...
  },
  {
    ...
    image: 'https://placehold.co/400x200?text=Style+Studio+Fashion',
...
export const fallbackNewArrivals: ProductItem[] = [
  ...
  },
  {
    ...
    brand: 'FitLife',
    image: 'https://placehold.co/400x300?text=Yoga+Mat+Premium',
  ...
  },
  {
    ...
    brand: 'BrewMaster',
    image: 'https://placehold.co/400x300?text=Coffee+Maker+Deluxe',
  ...
  },
  {
    ...
    name: 'LED Desk Lamp',
    brand: 'LightPro',
    image: 'https://placehold.co/400x300?text=LED+Desk+Lamp',
...
export const fallbackBrandedStores: BrandedStoreItem[] = [
  {
    ...
    title: 'Nike',
    brandName: 'Nike',
    image: 'https://placehold.co/400x200?text=Nike',
  ...
  },
  {
    ...
    title: 'Adidas',
    brandName: 'Adidas',
    image: 'https://placehold.co/400x200?text=Adidas',
  ...
  },
  {
    ...
    title: 'Samsung',
    brandName: 'Samsung',
    image: 'https://placehold.co/400x200?text=Samsung',
