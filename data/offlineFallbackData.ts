...
export const fallbackEvents: EventItem[] = [
  {
    ...
    image: 'https://via.placeholder.com/400x200?text=Weekend+Shopping+Festival',
  ...
  },
  {
    ...
    image: 'https://via.placeholder.com/400x200?text=Virtual+Product+Launch',
  ...
  },
  {
    ...
    image: 'https://via.placeholder.com/400x200?text=Fashion+Show+And+Sale',
...
export const fallbackRecommendations: RecommendationItem[] = [
  {
    ...
    brand: 'AudioTech',
    image: 'https://via.placeholder.com/400x300?text=Premium+Wireless+Headphones',
  ...
  },
  {
    ...
    brand: 'FitPro',
    image: 'https://via.placeholder.com/400x300?text=Smart+Fitness+Watch',
  ...
  },
  {
    ...
    brand: 'EcoWear',
    image: 'https://via.placeholder.com/400x300?text=Organic+Cotton+T-Shirt',
  ...
  },
  {
    ...
    brand: 'HydroLife',
    image: 'https://via.placeholder.com/400x300?text=Stainless+Steel+Water+Bottle',
...
export const fallbackTrendingStores: StoreItem[] = [
  {
    ...
    image: 'https://via.placeholder.com/400x200?text=TechHub+Electronics',
  ...
  },
  {
    ...
    image: 'https://via.placeholder.com/400x200?text=Fresh+Mart+Groceries',
  ...
  },
  {
    ...
    image: 'https://via.placeholder.com/400x200?text=Style+Studio+Fashion',
...
export const fallbackNewArrivals: ProductItem[] = [
  ...
  },
  {
    ...
    brand: 'FitLife',
    image: 'https://via.placeholder.com/400x300?text=Yoga+Mat+Premium',
  ...
  },
  {
    ...
    brand: 'BrewMaster',
    image: 'https://via.placeholder.com/400x300?text=Coffee+Maker+Deluxe',
  ...
  },
  {
    ...
    name: 'LED Desk Lamp',
    brand: 'LightPro',
    image: 'https://via.placeholder.com/400x300?text=LED+Desk+Lamp',
...
export const fallbackBrandedStores: BrandedStoreItem[] = [
  {
    ...
    title: 'Nike',
    brandName: 'Nike',
    image: 'https://via.placeholder.com/400x200?text=Nike',
  ...
  },
  {
    ...
    title: 'Adidas',
    brandName: 'Adidas',
    image: 'https://via.placeholder.com/400x200?text=Adidas',
  ...
  },
  {
    ...
    title: 'Samsung',
    brandName: 'Samsung',
    image: 'https://via.placeholder.com/400x200?text=Samsung',
